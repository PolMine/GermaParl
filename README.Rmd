...
[![Travis-CI Build Status](https://travis-ci.org/PolMine/GermaParl.svg?branch=dev)](https://travis-ci.org/PolMine/GermaParl)
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/PolMine/GermaParl?branch=dev&svg=true)](https://ci.appveyor.com/project/PolMine/germaparl)
...
Blaette, Andreas (2020): GermaParl. Download and Augment the Corpus of Plenary Protocols of the German Bundestag. R package version 1.4.0. https://CRAN.R-project.org/package=GermaParl
