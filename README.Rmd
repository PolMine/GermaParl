...
[![Travis-CI Build Status](https://travis-ci.org/PolMine/GermaParl.svg?branch=zenodo)](https://travis-ci.org/PolMine/GermaParl)
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/PolMine/GermaParl?branch=zenodo&svg=true)](https://ci.appveyor.com/project/PolMine/germaparl)
...
Note that the corpus will be stored within the directory structure of the GermaParl package. Whenever you update the GermaParl R package, it will be necessary to download the corpus anew.
...
Blaette, Andreas (2020): GermaParl R Data Package. v1.2.1.9003. https://CRAN.R-project.org/package=GermaParl

Blaette, Andreas (2020): GermaParl CWB Corpus (v1.0.5). https://doi.org/10.5281/zenodo.3735141
