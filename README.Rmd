...
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/PolMine/GermaParl?branch=master&svg=true)](https://ci.appveyor.com/project/PolMine/germaparl)
...
### Simple Video Tutorials for Germaparl (in German)
 Produced for a longer class on Parliamentary analysis in R (https://github.com/cgnguyen/parlament_in_r) the four videos give a brief introduction to some of the functionality of GermaParl and polmineR.
