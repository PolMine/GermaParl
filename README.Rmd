...
To keep things simple, both the GermaParl R package and the GermaParl corpus have a [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/) license. That means:
